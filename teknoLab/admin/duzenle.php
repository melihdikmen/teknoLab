  			...
  			<div class="row">
				<div class="panel panel-success">
					...
					<div class="form-group">
						  ...
						  <select class="form-control" id="sel1" name="selad">
                <?php
                include ("baglan.php");
                ...
                ?>
					...
					<input type="text" class="form-control" id="passwrod">
					<button type="submit" class="btn btn-danger pull-right" style="margin-top: 5px; margin-bottom: 5px;">Sil</button>
					<button type="submit" class="btn btn-success pull-right" style="margin-top: 5px; margin-bottom: 5px;">Güncelle</button>
				</div>
			</div>
